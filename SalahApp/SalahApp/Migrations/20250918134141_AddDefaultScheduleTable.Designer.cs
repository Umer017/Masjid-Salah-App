...
namespace SalahApp.Migrations
{
    ...
    [Migration("20250918134141_AddDefaultScheduleTable")]
    partial class AddDefaultScheduleTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalahApp.Models.DefaultSchedule", b =>
                {
            ...
            modelBuilder.Entity("SalahApp.Models.DefaultSchedule", b =>
                {
                    b.HasOne("SalahApp.Models.Masjid", "Masjid")
                        .WithOne("DefaultSchedule")
                        .HasForeignKey("SalahApp.Models.DefaultSchedule", "MasjidId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
